...
export class InspireEntertainPage {
  readonly page: Page;
  ...
  async goto() {
    await this.page.goto('/tags/1282');
  }

  async clickInspireEntertainNav() {
  ...
  async isOnInspireEntertainPage(): Promise<boolean> {
    return this.page.url().includes('/tags/1282');
  }
}
