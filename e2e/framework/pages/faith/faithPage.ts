...
export class FaithPage {
  ...
  constructor(page: Page) {
    ...
    this.navLink = page.locator('a.moj-primary-navigation__link[href="/tags/1286"]');
  ...
  async goto() {
    await this.page.goto('/tags/1286');
  }
  ...
  async isOnFaithPage(): Promise<boolean> {
    return this.page.url().includes('/tags/1286');
  }
}
