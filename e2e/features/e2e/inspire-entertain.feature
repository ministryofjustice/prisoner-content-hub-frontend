Feature: Inspire and Entertain Page

  Scenario: Navigate to Inspire and Entertain page directly
    Given I am on the Prisoner Content Hub
    When I navigate to the Inspire and Entertain page
    Then I should see the Inspire and Entertain page heading
    And content should be loaded on the page

  Scenario: Navigate to Inspire and Entertain via navigation link
    Given I am on the Prisoner Content Hub home page
    When I click on the "Inspire and entertain" navigation link
    Then I should be on the Inspire and Entertain page
    And the URL should contain "/tags/1282"

  Scenario: View content cards on Inspire and Entertain page
    Given I am on the Inspire and Entertain page
    When the page loads
    Then I should see content cards displayed
    And there should be at least one content card visible

  Scenario: Search for content on Inspire and Entertain page
    Given I am on the Inspire and Entertain page
  ...
  Scenario: Handle browser back button after error
    ...
    Then I should return to the Inspire and Entertain page
    And the page should be fully functional

  Scenario: Handle invalid URL parameters
    Given I am on the Prisoner Content Hub
    When I navigate to the Inspire and Entertain page with invalid parameters
    Then the page should ignore invalid parameters
    And display the default Inspire and Entertain content
