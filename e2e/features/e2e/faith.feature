Feature: Faith Page - Functional Behavior

  # Core Navigation Tests
  Scenario: Page loads successfully via direct URL
    Given I navigate to /tags/1286
  ...
  Scenario: Page loads successfully via navigation link
    ...
    When I click the navigation link for /tags/1286
    Then the URL should update to /tags/1286
    And the page heading should be visible

  Scenario: Page renders content structure
    Given I am on /tags/1286
    When the page loads
  ...
  Scenario: Series tile navigation works when clicked
    ...
    Then the URL should change from /tags/1286
