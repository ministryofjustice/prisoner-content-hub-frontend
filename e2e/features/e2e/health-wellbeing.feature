Feature: Health and Wellbeing Page

  Scenario: Navigate to Health and Wellbeing page directly
    Given I am on the Prisoner Content Hub
    When I navigate to the Health and Wellbeing page
    Then I should see the Health and Wellbeing page heading
    And content should be loaded on the page

  Scenario: Navigate to Health and Wellbeing via navigation link
    Given I am on the Prisoner Content Hub home page
    When I click on the "Health and wellbeing" navigation link
    Then I should be on the Health and Wellbeing page
    And the URL should contain "/tags/1284"

  Scenario: View content cards on Health and Wellbeing page
    Given I am on the Health and Wellbeing page
    When the page loads
    Then I should see content cards displayed
    And there should be at least one content card visible

  Scenario: Search for content on Health and Wellbeing page
    Given I am on the Health and Wellbeing page
    When I search for "mental health"
  ...
  Scenario: Handle browser back button after error
    ...
    Then I should return to the Health and Wellbeing page
    And the page should be fully functional

  Scenario: Handle invalid URL parameters
    Given I am on the Prisoner Content Hub
    When I navigate to the Health and Wellbeing page with invalid parameters
    Then the page should ignore invalid parameters
    And display the default Health and Wellbeing content
