  ...
  describe('transform', () => {
    ...
    it('should retrieve resized image when available', async () => {
      ...
      expect(query.transform(videoPage)).toStrictEqual({
        ...
        image: {
          alt: 'faith',
          url: 'https://cms.org/styles/tile_large/image.png',
        },
        media: 'https://cms.org/jdajsgjdfj.mp4',
        seasonId: 1,
        secondaryTags: [
