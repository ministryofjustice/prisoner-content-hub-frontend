  ...
  describe('transform', () => {
    it('should create correct video page structure', async () => {
      const videoPage = {
        ...
        fieldDescription: { processed: 'Education content for prisoners' },
