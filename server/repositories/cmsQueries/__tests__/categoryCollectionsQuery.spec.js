  ...
  describe('path', () => {
    it('should create correct path', () => {
      expect(query.path()).toStrictEqual(
        `/jsonapi/prison/${ESTABLISHMENTNAME}/taxonomy_term/moj_categories/${UUID}/sub_terms?include=field_featured_image&fields%5Btaxonomy_term--series%5D=type%2Cdrupal_internal__tid%2Cname%2Cfield_featured_image%2Cpath%2Ccontent_updated%2Cchild_term_count&fields%5Btaxonomy_term--moj_categories%5D=type%2Cdrupal_internal__tid%2Cname%2Cfield_featured_image%2Cpath%2Ccontent_updated%2Cchild_term_count&${getPagination(
          PAGE,
          LIMIT,
        )}`,
      );
