...
describe('Recently Added Content page query', () => {
  ...
  beforeEach(() => {
    ...
    query = new HomepageUpdatesContentQuery(ESTABLISHMENTNAME, 1, 40, 'en');
  });
  afterEach(() => {
    jest.useRealTimers();
  });
